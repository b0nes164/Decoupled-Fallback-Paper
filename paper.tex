...
\begin{table*}
  ...
  \begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} l r r r r r}
    \toprule
    Metric & Nvidia 2080 Super & Intel HD620 & AMD 7900 XT & ARM Mali-G78 MP20 & Apple M1 Pro Max \\  
    \midrule
    Memcopy                  & 54.203  & 1.498   & 71.190  & 106.663 & 54.203  \\  
    RTS                      & 35.709  & 1.060   & 62.868  & 82.302  & 35.709  \\  
    CSDLDF                   & 53.256  & 1.487   & 95.737  & 112.430 & 53.256  \\  
    CSDLDF/Memcopy           & 0.983   & 0.992   & 1.345   & 1.054   & 0.983   \\  
    CSDLDF/RTS               & 1.491   & 1.402   & 1.523   & 1.366   & 1.491   \\  
    Avg. Spins/Workgroup     & 0.418   & 0.306   & 0.133   & 1.380   & 0.418   \\  
    Avg. Lookback/Workgroup  & 13.139  & 1.725   & 20.867  & 3.510   & 13.139  \\  
    Fallbacks Initiated      & 88.384  & 260.364 & 10.127  & 2202.045& 88.384  \\  
    Successful Insertions    & 1.205   & 6.084   & 1.001   & 57.875  & 1.205   \\  
    \bottomrule
  \end{tabular*}
  \caption{Harmonic Means and Ratios for Various Devices, (Mali Absolute Statistics incorrect, need M1 Statistics)}
  \label{tab:results}
\end{table*}

We configure workgroups with a size $w = 256$ threads, where each thread processes $p = 4$ vectors of size 4, resulting in 16 elements per thread and a total work tile size $t = 4096$. We find a maximum spin count of 4 as offering good responsiveness to blocking, while minimizing false-positives fallbacks. As the size of the local spine is inversely proportional to the subgroup size, we allocate sufficient shared memory to accommodate the minimum subgroup size specified by the WebGPU standard, which is 4. Due to our overall thriftiness with shared memory, total shared memory usage remains modest at only 1 KB. We choose a diverse range of hardware vendors, with. For all tests, we use an input size of $2^{25}$. 
...
\begin{figure*}[t] % [t] forces the figure to appear at the top
  \centering
  ...
  \vspace{0.2em} % Adjust vertical spacing between rows
