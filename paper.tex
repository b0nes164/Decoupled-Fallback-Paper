...
Due to its significance in circuits and as a fundamental algorithmic primitive, scan enjoys a rich literature in both electrical engineering and computer science. Harris provides a taxonomy relating depth, fanout, and wire tracks. Hinze provides an algebra of scans. Snir proved that depth and size are related by . Fich proved that . Merill and Garland provide a comprehensive review of GPU scan implementations in . In light of this work(reword this), our focus is on exploring the progression of inter-workgroup (global) scan strategies and their fitness relative to our ideal architecture.
