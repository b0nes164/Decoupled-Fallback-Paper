...
\begin{figure*}[!t]
  ...
  \caption{The four global scan techniques described in \ref{sec:Evolution}. Dashed grey boxes indicate individual kernel launches.}
...
\begin{figure*}[t]
  ...
  \caption{\emph{Decoupled Fallback}. For brevity, the chained propagation phase is condensed, see \ref{fig:decoupled-lookback} for the full behavior.}
...
\begin{acks}
We thank Elias Naur for his initial work on Scalar Fallback, Ken Russell for facilitating this colloboration, Duane Merrill for answering our questions about scan terminology, and Oliver Le for providing the initial testing on Apple devices.
\end{acks}
