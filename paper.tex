...
\begin{figure}
  ...
  \caption{Execution times of \emph{Decoupled Lookback} (PLACEHOLDER DATA). The TDR threshold represents the duration after which the OS, assuming a non-terminating kernel, kills the driver. \john{This figure needs to be cited in the text.}}
\end{figure}
