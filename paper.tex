...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.45\linewidth}
    ...
    \label{fig:ours}
  \end{subfigure}
  \caption{Histogram plots, Inclusive Prefix Sum, $\mathbf{2^{25}}$ 32-bit elements, on an FPG-lacking device, Apple M1 Max. The TDR threshold is Windows's threshold for resetting the GPU\@; as noted in Section~\ref{sec:tdr}, MacOS handles this differently.}
  \label{fig:dist}
\end{figure}
