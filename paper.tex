...
\begin{itemize}
  ...
  \item \textbf{Heterogeneous System Architecture~\cite{} (HSA)}: The workgroup with the lowest ID that has not yet terminated.
...
\end{itemize}
Their findings in in \cite{sorensen2021} demonstrated that Apple and ARM GPUs do not support LOBE, contradicting their prior hypothesis in \cite{sorensen2018}.
