...
\begin{figure}
  ...
  \caption{(This graph can be provided with or without Memcpy speeds. I am thinking without, as it's currently very busy.) Performance versus CUB (NVIDIA 2080 Super)}
\end{figure}
